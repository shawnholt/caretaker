...
**Next implementation order.** Collect representative disk latency, paging, and resource history if slowdown diagnosis needs stronger causal evidence; measure normal-use chat cost and sustained lifecycle. Keep the existing 15-minute checker and PerfMon-off setting. Do not attach to or change the bridge-owned Codex child.
